...
By following this principle, Go-Web reduces the need for “repetitive” tasks like explicitly binding routes, actions and middleware; while not problematic per se, programmers may want to adopt “ready-to-use” solutions, for instances if they want easily build complex services or have a non-Go background, aiming at a reduced “productive lag” which could be experienced when approaching new technology.
